...
echo "── 4. Kỳ sao kê và ngày đến hạn ───────────────────────────────────────────"
...
echo "── 5. Import lại sau khi đổi tên KHÔNG ghi đè tên người dùng ──────────────"
import "$TOKEN" "$TMP/the.csv" > /dev/null
...
echo "── 6. Cô lập dữ liệu giữa user (IDOR) ────────────────────────────────────"
...
echo "── 7. Xoá nguồn tiền đang có giao dịch bị chặn ───────────────────────────"
